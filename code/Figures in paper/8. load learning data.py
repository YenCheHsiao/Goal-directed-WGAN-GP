...
input_dir1 = data_file + 'data/In paper/' + method + '/' + 'epoch' + str(num_epochs_1000)
...
# 1. GAN+CNN (no label)
method = 'GAN_RL_old'
input_dir2 = data_file + 'data/In paper/' + method + '/' + 'epoch' + str(num_epochs_1000)
...
plt.grid()
plt.savefig(data_file + "results/(In paper) Learning curve.png", bbox_inches='tight')
plt.show()
