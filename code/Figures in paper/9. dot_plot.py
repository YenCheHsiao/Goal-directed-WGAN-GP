...
plt.title('WGAN-GP without\nimmunogenicity predictor\n', y=1.02, fontsize=30, weight='bold')
# plt.legend(['WGAN-GP'], loc='best', fontsize=20)
plt.legend(['Peptide from the WGAN-GP'], bbox_to_anchor=(0., 1.15), loc='upper left',fontsize=20)
plt.xlabel('Immunogenicity score', fontsize=30, weight='bold')
plt.ylabel('MaxSimilarity', fontsize=30, weight='bold')
plt.grid()
plt.savefig(data_file + "results/(In paper) no predictor.png", bbox_inches='tight')
plt.show()
...
# plt.legend(['Goal-directed WGAN-GP'], loc='best', fontsize=20)
plt.legend(['Peptide from the goal-directed WGAN-GP'], bbox_to_anchor=(0., 1.15), loc='upper left', fontsize=20)
plt.xlabel('Immunogenicity score', fontsize=30, weight='bold')
plt.ylabel('MaxSimilarity', fontsize=30, weight='bold')
plt.grid()
plt.savefig(data_file + "results/(In paper) with predictor.png", bbox_inches='tight')
plt.show()
...
plt.grid()
plt.savefig(data_file + "results/(In paper) violin.png", bbox_inches='tight')
plt.show()
...
plt.savefig(data_file + "results/(In paper) bar plot.png", bbox_inches='tight')
plt.show()
...
plt.grid()
plt.savefig(data_file + "results/(In paper) box plot.png", bbox_inches='tight')
plt.show()