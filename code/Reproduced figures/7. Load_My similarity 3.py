...
for c in ax2.containers:
    ...
    ax2.bar_label(c, labels=labels, label_type='edge',fontsize = 30*3, rotation=-90, weight='bold')
...
plt.grid()
plt.savefig(data_file + "results/(New) Similarity compare.png", bbox_inches='tight')
plt.show()
