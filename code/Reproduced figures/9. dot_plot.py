...
"""
ep = 'epoch1000'
batch_size = 100000 # 60000 peptides
method = 'WGAN-GP'
num_epochs = 399
num_epochs = 1000

outdir_1 = data_file + 'results/' + method + '/' + ep + '/'
...
plt.grid()
plt.savefig(data_file + "results/(New) no predictor.png", bbox_inches='tight')
plt.show()
...
plt.ylabel('MaxSimilarity', fontsize=30, weight='bold')
plt.grid()
plt.savefig(data_file + "results/(New) with predictor.png", bbox_inches='tight')
plt.show()
...
plt.grid()
plt.savefig(data_file + "results/(New) violin.png", bbox_inches='tight')
plt.show()
...
plt.savefig(data_file + "results/(New) bar plot.png", bbox_inches='tight')
plt.show()
...
plt.grid()
plt.savefig(data_file + "results/(New) box plot.png", bbox_inches='tight')
plt.show()