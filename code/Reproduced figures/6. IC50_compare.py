...
"""
ep = 'epoch0'
data_path = data_file + 'results/' + method + '/' + ep + '/NetMHCpan_prediction_' + ep + '.csv'
...
ep = 'epoch80'
data_path = data_file + 'dresults/' + method + '/' + ep + '/NetMHCpan_prediction_' + ep + '.csv'
prediction = pd.read_csv(data_path)
...
plt.savefig(data_file + "results/(New) IC50 compare.png", bbox_inches='tight')
plt.show()
...
ax.set_ylim(0, 1100)
#fig.set_size_inches(18.5, 10.5)
plt.savefig(data_file + "results/(New) IC50 Imm.png", bbox_inches='tight')
plt.show()