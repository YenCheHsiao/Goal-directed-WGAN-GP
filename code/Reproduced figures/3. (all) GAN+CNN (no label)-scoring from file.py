...
'''
"""
Created on Sat Jun  3 13:25:09 2023
...
for j in range(len(ep)):
    ...
    outname = 'deepimmuno-GANRL-bladder_cancer-scored_epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '.txt'
    """
    Test peptides data
    """
    #data_path = 'D:/PhD thesis/GCN/My Code/' + method + '/' + ep[i] + '/deepimmuno-GANRL-bladder-' + ep[i] + '_rmv.txt'
    data_path = data_file + 'results/' + method + '/' + ep[j] + '/deepimmuno-GANRL-bladder-epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '_rmv.txt'
    ...
    print(sum(scoring>0.5))
    print(len(scoring))
    print(float(sum(scoring>0.5)/len(scoring)))
...
print("outdir is {}".format(outdir))
outname = 'deepimmuno-GANRL-bladder_cancer-scored_epoch' + str(num_epochs) + '-batch' + str(batch_size) + '.txt'
"""
Test peptides data
"""
