...
outdir = data_file + 'Data/In paper/' + method + '/epoch' + str(epoch_file)
...
G.load_state_dict(torch.load(data_file + 'Data/In paper/' + method + '/epoch' + str(epoch_file) + '/model_epoch_' + str(num_epochs) + '.pth'))
